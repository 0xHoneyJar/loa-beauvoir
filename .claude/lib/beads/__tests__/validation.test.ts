...
describe("validateBeadId", () => {
  ...
  describe("SECURITY: injection payloads", () => {
    it.each(INJECTION_PAYLOADS)("should reject injection payload: %s", (payload) => {
  ...
  describe("type checking", () => {
    ...
    it("should reject undefined", () => {
      expect(() => validateBeadId(undefined)).toThrow("must be a non-empty string");
    });
    ...
    it("should reject objects", () => {
      expect(() => validateBeadId({ id: "task" })).toThrow("must be a non-empty string");
    });

    it("should reject arrays", () => {
      expect(() => validateBeadId(["task"])).toThrow("must be a non-empty string");
    });
  });
...
describe("shellEscape", () => {
  ...
  it("should reject non-string inputs", () => {
    expect(() => shellEscape(123 as unknown as string)).toThrow("requires a string input");
...
describe("filterValidLabels", () => {
  it("should keep valid labels", () => {
    ...
    expect(filterValidLabels(labels)).toEqual(["sprint:in_progress", "run:current", "epic"]);
  });
