 ...
 */
export type BeadClassification = "decision" | "discovery" | "blocker" | "context" | "routine";
 ...
 */
export function classificationToLabel(classification: BeadClassification): string {
 ...
 */
export function deriveClassification(beadLabels: string[]): BeadClassification | null {
 ...
 */
export function deriveConfidence(beadLabels: string[]): ConfidenceLevel | null {
 ...
 */
export function classificationPriority(classification: BeadClassification | null): number {
